...
export const apexConfig = {
  ...
  /** Budget API base for Document DB writes (proxied to server in dev). */
  budgetApiUrl: import.meta.env.VITE_BUDGET_API_URL ?? '/api',
};

export const apexDbReadConfigured = Boolean(apexConfig.apiKey);
